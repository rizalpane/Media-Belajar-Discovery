...
<body>
    <nav class="navbar bg-light p-3 mb-5">
        <div class="container-fluid ">
            <h4 class="animated bounceIn title fw-bold ">TAHAP PENGUMPULAN DATA</h4>
            <div class="d-flex">
                <a class="animated bounceIn btn btn-primary fw-bold me-2" href="03.php"><i class="bi bi-skip-start-fill "></i> Back</a>
                <a class="animated bounceIn btn btn-primary fw-bold" href="05.php">Next <i class="bi bi-skip-end-fill "></i></a>
            </div>
        </div>
    </nav>
    <div class="container">
